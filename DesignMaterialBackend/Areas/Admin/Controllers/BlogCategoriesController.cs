...
namespace DesignMaterialBackend.Areas.Admin.Controllers
{
    ...
    public class BlogCategoriesController : Controller
    {
        ...
        public BlogCategoriesController(DesignMaterialDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryName,Slug")] BlogCategory blogCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryName,Slug")] BlogCategory blogCategory)
        {
